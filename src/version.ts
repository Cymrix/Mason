 ...
 */
export const MASON_VERSION = '0.206';
export const MASON_VERSION_DISPLAY = 'v0.206';
export const MASON_FULL_VERSION = 'v0.206';
...
export const MASON_RELEASE_HISTORY = [
  {
    ...
    date: '2026-08-29',
    changes: [
      'Cleaned raw escaped unicode sequences back to valid native UTF-8 bytes without BOM.',
      'Verified clean production bundle transformation (1,754 modules built in 18.5s) for GitHub Actions runner compatibility.'
    ]
  },
  {
    version: 'v0.205',
    date: '2026-08-29',
    changes: [
      'Sanitized non-ASCII character sequences and variation selectors across PrefabEditor.tsx.',
      'Guaranteed pure UTF-8 encoding across all component source files to fix GitHub Actions build transformer errors.'
    ]
  },
  {
    version: 'v0.204',
    date: '2026-08-29',
    changes: [
      'Cleaned and validated PrefabEditor.tsx syntax and verified clean production build for GitHub Actions deployment.'
    ]
  },
  {
    version: 'v0.203',
